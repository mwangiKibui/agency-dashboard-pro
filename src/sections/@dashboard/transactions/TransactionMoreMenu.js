...
export default function TransactionMoreMenu({ transactionDetails }) {
    ...
    <>
      ...
      >
        <MenuItem
          ...
          onClick={() => {
            navigate(`/dashboard/transaction/info/${transactionDetails._id}`);
          }}
        >
          <ListItemIcon>
        ...
        <MenuItem
          ...
          to={`/dashboard/transaction/edit/${transactionDetails._id}`}
          sx={{ color: 'text.secondary' }}
        >
          <ListItemIcon>

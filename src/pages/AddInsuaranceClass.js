...
import { addInsuaranceClass } from '../store/insuarance_class/actions';

// ----------------------------------------------------------------------

export default function AddInsuaranceClass() {
  const dispatch = useDispatch();
  const { isAdding, message, error } = useSelector((state) => state.insuaranceClass);
  ...
  const AddInsuaranceClassSchema = Yup.object().shape({
  ...
  const formik = useFormik({
    ...
    validationSchema: AddInsuaranceClassSchema,
    onSubmit: () => {
